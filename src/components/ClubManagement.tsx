...
export function ClubManagement({ clubId, showClubSelector = false }: ClubManagementProps) {
  ...
  // Handle clubId prop changes for admin users
  useEffect(() => {
    if (user?.role === "admin" && clubId && clubId !== selectedClubId) {
