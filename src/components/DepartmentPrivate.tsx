...
import { DepartmentPublic } from "./DepartmentPublic";
...
export function DepartmentPrivate({deptId}:{deptId?:string}) {
    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          {user?.role === "admin" && availableDepartments.length > 0 && !deptId&& (
        ...
        {pathName=="/dashboard"&&(<DepartmentPublic key={selectedDeptId} deptId={selectedDeptId}/>)}
        <h2 className="text-foreground text-xl mx-2 my-5">
